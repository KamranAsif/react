...
describe('ProfilingCache', () => {
  ...
  it('should properly detect when a component is missing a shallow/deep memo for props', () => {
    ...
    // Third render. We increment count and expect props to not be memoizable.
    ...
    // telling us canPropsBeMemoized to be true
  ...
  it('should properly detect when a component is missing a shallow/deep memo for state', () => {
    ...
    // Third render. We increment count and expect state to not be memoizable.
    expect(getPerfInsightSnapshot(2)).toMatchInlineSnapshot(`
      Map {
        2 => Object {
          "canAllChangedHooksBeMemoized": false,
    ...
    // telling us canStateBeMemoized to be true
    expect(getPerfInsightSnapshot(3)).toMatchInlineSnapshot(`
      Map {
        2 => Object {
          "canAllChangedHooksBeMemoized": false,
  ...
  it('should properly detect when a component is being passed a non memoized function or component', () => {
    ...
    // Third render should only emit propsNeedingMemoization values
    utils.act(() =>
      legacyRender(
        <>
    ...
    // Third render. Props changed and track propsNeedingMemoization values.
    expect(getPerfInsightSnapshot(2)).toMatchInlineSnapshot(`
      Map {
        4 => Object {
          "canAllChangedHooksBeMemoized": false,
    ...
    // Fourth render. We update memoized values but it shouldn't be included in propsNeedingMemoization.
    expect(getPerfInsightSnapshot(3)).toMatchInlineSnapshot(`
      Map {
        4 => Object {
          "canAllChangedHooksBeMemoized": false,
